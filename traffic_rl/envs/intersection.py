...
from ..common.runtime import ROOT, configure_sumo
from ..networks.scenario import DIRECTIONS, network, routes
...
class IntersectionEnv(gym.Wrapper):
    ...
    def baseline_action(self, policy):
        from ..agents.baselines import intersection_action
        return intersection_action(self, policy)
